...
public class CaculatorTest {
    ...
    public void testSum_two_floatNumbers() {
        System.out.println("CaculatorTest: testSum_two_floatNumbers");
    ...
    public void testSum_two_floatNumbers_case2() {
        System.out.println("CaculatorTest: testSum_two_floatNumbers_case2");
        Caculator instance = new Caculator(3.0f, 4.0f);
        float result = instance.sum();
    ...
    public void testSum_two_floatNumbers_case3() {
        System.out.println("CaculatorTest: testSum_two_floatNumbers_case3");
    ...
    public void testSum_two_floatNumbers_case4() {
        System.out.println("CaculatorTest: testSum_two_floatNumbers_case4");
    ...
    public void testSum_two_floatNumbers_case5() {
        System.out.println("CaculatorTest: testSum_two_floatNumbers_case5");
        Caculator instance = new Caculator(3.0f, 4.0f);
        float result = instance.sum();
